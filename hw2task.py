...
def calculate(measurements, initial_xy):
  ...
  F =  matrix([[1.,0.,dt,0.], [0.,1.,0.,dt], [0.,0.,1.,0.], [0.,0.,0.,1.]]) #matrix([[1.,1.,1.,dt], [1.,1.,1.,dt], [0.,0.,0.,1.], [0.,0.,0.,1.]]) # next state function
...
##
##rx, rP = calculate(measurements,initial_xy)
#rx.show()
#rP.show()
##dt = 0.1
...
###u = matrix([[0.], [0.], [0.], [0.]]) # external motion
##calculate(measurements,initial_xy)
##### fill this in: ###
###F =  matrix([[1.,0.,1.,0.], [0.,1.,0.,1.], [0.,0.,0.,dt], [0.,0.,0.,dt]]) # next state function
##
###x = (F * x) + u
#x.show()